...
import { login, logout, signup } from '../controllers/auth.controller.js'; // Importing the authentication-related controller functions (signup, login, logout) from the auth.controller.js file
